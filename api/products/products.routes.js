...
// Admin Routes
router.post('/add', authenticate, authorizeAdmin, upload.array('images', 5), addProduct);
router.put('/update/:productId', authenticate, authorizeAdmin, upload.array('images', 5), updateProduct);
